  ...
  var result = {
    ...
    parse: function(input, startRule) {
      var parseFunctions = {
        ...
        "argument_description_TEXT_BLOCK": parse_argument_description_TEXT_BLOCK,
        "VALUE": parse_VALUE,
        ...
        "NAME": parse_NAME,
        "KEY": parse_KEY,
        "TEXT_CHUNK": parse_TEXT_CHUNK,
        "TEXT_BLOCK": parse_TEXT_BLOCK,
        "ANY": parse_ANY,
        "FEED": parse_FEED,
        "FREE_FEED": parse_FREE_FEED,
        "_": parse__,
        "$": parse_$
      };
      ...
      function parse_entity() {
        ...
        if (result0 !== null) {
          ...
          if (result1 !== null) {
            result2 = parse_heading();
            if (result2 !== null) {
              result3 = parse_description();
              if (result3 !== null) {
                result4 = parse_CLOSE();
                if (result4 !== null) {
                  result5 = (function(offset, line, column) {
      ...
      function parse_heading() {
        ...
        if (result0 !== null) {
          result1 = parse_signatures();
          if (result1 === null) {
            result1 = parse_class();
            if (result1 === null) {
              result1 = parse_mixin();
              if (result1 === null) {
                result1 = parse_section();
                if (result1 === null) {
                  result1 = parse_namespace();
                }
              }
            }
          }
      ...
      function parse_signatures() {
        ...
        if (result0 !== null) {
          ...
          result1 = parse_FEED();
          if (result1 !== null) {
            result2 = parse_argument_descriptions();
            if (result2 !== null) {
              result1 = [result1, result2];
            } else {
              result1 = null;
        ...
        if (result0 !== null) {
          ...
          if (result1 !== null) {
            ...
            if (result2 !== null) {
              ...
              if (result3 !== null) {
                result3 = (function(offset, line, column, nested) { return nested; })(pos2.offset, pos2.line, pos2.column, result3[3]);
              }
              if (result3 === null) {
                pos = clone(pos2);
              }
      ...
      function parse_args() {
        ...
        if (result0 !== null) {
          ...
          if (result1 !== null) {
            result1 = (function(offset, line, column, args) { return args; })(pos2.offset, pos2.line, pos2.column, result1[3]);
          }
          if (result1 === null) {
            pos = clone(pos2);
          }
          ...
          if (result1 !== null) {
            ...
            if (result2 !== null) {
              result2 = (function(offset, line, column, args) { return args; })(pos2.offset, pos2.line, pos2.column, result2[5]);
            }
            if (result2 === null) {
              pos = clone(pos2);
            }
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, first, rest, opt) {
            rest = rest || [];
            if(first){
              rest.unshift(first);
            }
      ...
      function parse_argument_descriptions() {
        ...
        pos0 = clone(pos);
        result0 = parse_argument_description();
        if (result0 !== null) {
          pos1 = clone(pos);
          result1 = parse_FEED();
          if (result1 !== null) {
              ...
              if (result3 !== null) {
                ...
                if (result4 !== null) {
                  ...
                  if (result5 !== null) {
                    ...
                    if (result6 !== null) {
                      result7 = parse_argument_description_TEXT_BLOCK();
                      if (result7 !== null) {
      ...
      function parse_argument_description_TEXT_BLOCK() {
        var result0, result1, result2, result3;
        var pos0, pos1, pos2, pos3;
        ...
        if (result0 !== null) {
          result1 = parse_TEXT_CHUNK();
          if (result1 !== null) {
            pos2 = clone(pos);
            pos3 = clone(pos);
            result2 = parse_FEED();
            if (result2 !== null) {
              result3 = parse_argument_description_TEXT_BLOCK();
              if (result3 !== null) {
                result2 = [result2, result3];
              } else {
                result2 = null;
            ...
            if (result2 !== null) {
              result2 = (function(offset, line, column, nested) { return '\n' + nested; })(pos2.offset, pos2.line, pos2.column, result2[1]);
            }
            if (result2 === null) {
              pos = clone(pos2);
            }
      ...
      function parse_TEXT_BLOCK() {
        ...
        if (result0 !== null) {
          ...
          if (result1 !== null) {
            ...
            if (result2 !== null) {
              result2 = (function(offset, line, column, feed, text) { return feed.join('') + text; })(pos2.offset, pos2.line, pos2.column, result2[0], result2[1]);
            }
            if (result2 === null) {
              pos = clone(pos2);
            }
      ...
      function parse_FEED() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, spacing) { return '\n' + spacing.join(''); })(pos0.offset, pos0.line, pos0.column, result0[4]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
      ...
      function parse_FREE_FEED() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, spacing) { return '\n' + spacing.join(''); })(pos0.offset, pos0.line, pos0.column, result0[3]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
