...
NDoc.prototype.toHTML = function(options) {
  ...
  function link(obj, short) {
    ...
    return '<a href="#' + obj.path + '" title="' + obj.id + ' (' + obj.type + ')" data-id="' + obj.id + '">' + (short ? obj.name : obj.id) + '</a>';
  }
  ...
  function short_link(obj) {
    ...
    return '<a href="#' + obj.path + '" title="' + obj.id + ' (' + obj.type + ')" class="link-method">' + obj.id + '</a>';
  }
