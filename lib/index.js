...
try {
  ...
  var grammar = require('jison/lib/jison/bnf').parse(Util.read(Util.join(base_dir, 'parser.y')));
  Util.write(Util.join(base_dir, 'parser.js'), (new Jison.Parser(grammar)).generate());
  }());
  parser = require('./parser');
}
